...
struct QueryPlannerInterfaces_Response_
{
  ...
  using _planner_interfaces_type =
    std::vector<moveit_msgs::msg::PlannerInterfaceDescription_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::PlannerInterfaceDescription_<ContainerAllocator>>::other>;
  _planner_interfaces_type planner_interfaces;

  // setters for named parameter idiom
  Type & set__planner_interfaces(
    const std::vector<moveit_msgs::msg::PlannerInterfaceDescription_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::PlannerInterfaceDescription_<ContainerAllocator>>::other> & _arg)
  {
