...
void GetPositionIK_Request__rosidl_typesupport_introspection_c__GetPositionIK_Request_init_function(
...
void GetPositionIK_Request__rosidl_typesupport_introspection_c__GetPositionIK_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetPositionIK_Request__rosidl_typesupport_introspection_c__GetPositionIK_Request_message_members = {
  ...
  GetPositionIK_Request__rosidl_typesupport_introspection_c__GetPositionIK_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetPositionIK_Request__rosidl_typesupport_introspection_c__GetPositionIK_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void GetPositionIK_Response__rosidl_typesupport_introspection_c__GetPositionIK_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetPositionIK_Response__rosidl_typesupport_introspection_c__GetPositionIK_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetPositionIK_Response__rosidl_typesupport_introspection_c__GetPositionIK_Response_message_members = {
  ...
  GetPositionIK_Response__rosidl_typesupport_introspection_c__GetPositionIK_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetPositionIK_Response__rosidl_typesupport_introspection_c__GetPositionIK_Response_fini_function  // function to terminate message instance (will not free memory)
};
