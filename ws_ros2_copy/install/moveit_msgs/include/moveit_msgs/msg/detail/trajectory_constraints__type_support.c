...
void TrajectoryConstraints__rosidl_typesupport_introspection_c__TrajectoryConstraints_init_function(
...
void TrajectoryConstraints__rosidl_typesupport_introspection_c__TrajectoryConstraints_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers TrajectoryConstraints__rosidl_typesupport_introspection_c__TrajectoryConstraints_message_members = {
  ...
  TrajectoryConstraints__rosidl_typesupport_introspection_c__TrajectoryConstraints_init_function,  // function to initialize message memory (memory has to be allocated)
  TrajectoryConstraints__rosidl_typesupport_introspection_c__TrajectoryConstraints_fini_function  // function to terminate message instance (will not free memory)
};
