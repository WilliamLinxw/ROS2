...
void CostSource__rosidl_typesupport_introspection_c__CostSource_init_function(
...
void CostSource__rosidl_typesupport_introspection_c__CostSource_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers CostSource__rosidl_typesupport_introspection_c__CostSource_message_members = {
  ...
  CostSource__rosidl_typesupport_introspection_c__CostSource_init_function,  // function to initialize message memory (memory has to be allocated)
  CostSource__rosidl_typesupport_introspection_c__CostSource_fini_function  // function to terminate message instance (will not free memory)
};
