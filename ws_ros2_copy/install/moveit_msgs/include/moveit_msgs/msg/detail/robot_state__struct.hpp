...
struct RobotState_
{
  ...
  using _attached_collision_objects_type =
    std::vector<moveit_msgs::msg::AttachedCollisionObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::AttachedCollisionObject_<ContainerAllocator>>::other>;
  ...
  Type & set__attached_collision_objects(
    const std::vector<moveit_msgs::msg::AttachedCollisionObject_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::AttachedCollisionObject_<ContainerAllocator>>::other> & _arg)
  {
