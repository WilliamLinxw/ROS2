...
void GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_init_function(
...
void GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_fini_function(void * message_memory)
{
  moveit_msgs__srv__GetMotionPlan_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_members = {
  "moveit_msgs__srv",  // message namespace
  "GetMotionPlan_Request",  // message name
  1,  // number of fields
  sizeof(moveit_msgs__srv__GetMotionPlan_Request),
  GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_member_array,  // message members
  GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_type_support_handle = {
  0,
  &GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, GetMotionPlan_Request)() {
  GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, MotionPlanRequest)();
  if (!GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_type_support_handle.typesupport_identifier) {
    GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetMotionPlan_Request__rosidl_typesupport_introspection_c__GetMotionPlan_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_fini_function(void * message_memory)
{
  moveit_msgs__srv__GetMotionPlan_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_members = {
  "moveit_msgs__srv",  // message namespace
  "GetMotionPlan_Response",  // message name
  1,  // number of fields
  sizeof(moveit_msgs__srv__GetMotionPlan_Response),
  GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_member_array,  // message members
  GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_type_support_handle = {
  0,
  &GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, GetMotionPlan_Response)() {
  GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, MotionPlanResponse)();
  if (!GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_type_support_handle.typesupport_identifier) {
    GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetMotionPlan_Response__rosidl_typesupport_introspection_c__GetMotionPlan_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
