...
#include <sensor_msgs/msg/joint_state__rosidl_typesupport_fastrtps_cpp.hpp>
...
{
    typedef bool (*des_t)(eprosima::fastcdr::Cdr &, sensor_msgs::msg::JointState &);
    des_t des = sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize;
    return std::make_unique<PublisherImpl<sensor_msgs::msg::JointState>>(node, topic, des);
}
...
{
    typedef size_t (*getsize_t)(const sensor_msgs::msg::JointState &, size_t);
    getsize_t getsize = sensor_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size;
    typedef bool (*ser_t)(const sensor_msgs::msg::JointState &, eprosima::fastcdr::Cdr &);
    ser_t ser = sensor_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize;

    return std::make_unique<SubscriptionImpl<sensor_msgs::msg::JointState>>(node, serial_mapping, topic, transporter, getsize, ser);
}
