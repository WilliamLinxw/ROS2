...
struct GenericTrajectory_
{
  ...
  using _cartesian_trajectory_type =
    std::vector<moveit_msgs::msg::CartesianTrajectory_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CartesianTrajectory_<ContainerAllocator>>::other>;
  ...
  Type & set__cartesian_trajectory(
    const std::vector<moveit_msgs::msg::CartesianTrajectory_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CartesianTrajectory_<ContainerAllocator>>::other> & _arg)
  {
