...
void ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_init_function(
...
void ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_fini_function(void * message_memory)
{
  moveit_msgs__srv__ChangeControlDimensions_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_member_array[6] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_members = {
  ...
  ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_member_array,  // message members
  ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_type_support_handle = {
  0,
  &ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ChangeControlDimensions_Request)() {
  if (!ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_type_support_handle.typesupport_identifier) {
    ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ChangeControlDimensions_Request__rosidl_typesupport_introspection_c__ChangeControlDimensions_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_fini_function(void * message_memory)
{
  moveit_msgs__srv__ChangeControlDimensions_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_member_array[1] = {
  {
    "success",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_members = {
  "moveit_msgs__srv",  // message namespace
  "ChangeControlDimensions_Response",  // message name
  1,  // number of fields
  sizeof(moveit_msgs__srv__ChangeControlDimensions_Response),
  ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_member_array,  // message members
  ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_type_support_handle = {
  0,
  &ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ChangeControlDimensions_Response)() {
  if (!ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_type_support_handle.typesupport_identifier) {
    ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ChangeControlDimensions_Response__rosidl_typesupport_introspection_c__ChangeControlDimensions_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
