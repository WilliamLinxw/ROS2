...
void JointConstraint__rosidl_typesupport_introspection_c__JointConstraint_init_function(
...
void JointConstraint__rosidl_typesupport_introspection_c__JointConstraint_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers JointConstraint__rosidl_typesupport_introspection_c__JointConstraint_message_members = {
  ...
  JointConstraint__rosidl_typesupport_introspection_c__JointConstraint_init_function,  // function to initialize message memory (memory has to be allocated)
  JointConstraint__rosidl_typesupport_introspection_c__JointConstraint_fini_function  // function to terminate message instance (will not free memory)
};
