...
struct MotionSequenceRequest_
{
  ...
  using _items_type =
    std::vector<moveit_msgs::msg::MotionSequenceItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::MotionSequenceItem_<ContainerAllocator>>::other>;
  _items_type items;

  // setters for named parameter idiom
  Type & set__items(
    const std::vector<moveit_msgs::msg::MotionSequenceItem_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::MotionSequenceItem_<ContainerAllocator>>::other> & _arg)
  {
    this->items = _arg;
    return *this;
  }
