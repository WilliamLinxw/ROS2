...
struct CartesianTrajectory_
{
  ...
  using _points_type =
    std::vector<moveit_msgs::msg::CartesianTrajectoryPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CartesianTrajectoryPoint_<ContainerAllocator>>::other>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<moveit_msgs::msg::CartesianTrajectoryPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CartesianTrajectoryPoint_<ContainerAllocator>>::other> & _arg)
  {
    this->points = _arg;
    return *this;
  }
