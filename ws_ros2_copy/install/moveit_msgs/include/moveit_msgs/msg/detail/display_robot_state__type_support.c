...
void DisplayRobotState__rosidl_typesupport_introspection_c__DisplayRobotState_init_function(
...
void DisplayRobotState__rosidl_typesupport_introspection_c__DisplayRobotState_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers DisplayRobotState__rosidl_typesupport_introspection_c__DisplayRobotState_message_members = {
  ...
  DisplayRobotState__rosidl_typesupport_introspection_c__DisplayRobotState_init_function,  // function to initialize message memory (memory has to be allocated)
  DisplayRobotState__rosidl_typesupport_introspection_c__DisplayRobotState_fini_function  // function to terminate message instance (will not free memory)
};
