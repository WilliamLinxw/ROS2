...
void ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_init_function(
...
void ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_fini_function(void * message_memory)
{
  moveit_msgs__srv__ChangeDriftDimensions_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_member_array[7] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_members = {
  ...
  ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_member_array,  // message members
  ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_type_support_handle = {
  0,
  &ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ChangeDriftDimensions_Request)() {
  ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Transform)();
  if (!ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_type_support_handle.typesupport_identifier) {
    ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ChangeDriftDimensions_Request__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_fini_function(void * message_memory)
{
  moveit_msgs__srv__ChangeDriftDimensions_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_member_array[1] = {
  {
    "success",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_members = {
  "moveit_msgs__srv",  // message namespace
  "ChangeDriftDimensions_Response",  // message name
  1,  // number of fields
  sizeof(moveit_msgs__srv__ChangeDriftDimensions_Response),
  ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_member_array,  // message members
  ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_type_support_handle = {
  0,
  &ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, ChangeDriftDimensions_Response)() {
  if (!ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_type_support_handle.typesupport_identifier) {
    ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ChangeDriftDimensions_Response__rosidl_typesupport_introspection_c__ChangeDriftDimensions_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
