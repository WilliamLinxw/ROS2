...
void OrientedBoundingBox__rosidl_typesupport_introspection_c__OrientedBoundingBox_init_function(
...
void OrientedBoundingBox__rosidl_typesupport_introspection_c__OrientedBoundingBox_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers OrientedBoundingBox__rosidl_typesupport_introspection_c__OrientedBoundingBox_message_members = {
  ...
  OrientedBoundingBox__rosidl_typesupport_introspection_c__OrientedBoundingBox_init_function,  // function to initialize message memory (memory has to be allocated)
  OrientedBoundingBox__rosidl_typesupport_introspection_c__OrientedBoundingBox_fini_function  // function to terminate message instance (will not free memory)
};
