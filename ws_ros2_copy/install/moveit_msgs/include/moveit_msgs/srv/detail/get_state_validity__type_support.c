...
void GetStateValidity_Request__rosidl_typesupport_introspection_c__GetStateValidity_Request_init_function(
...
void GetStateValidity_Request__rosidl_typesupport_introspection_c__GetStateValidity_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetStateValidity_Request__rosidl_typesupport_introspection_c__GetStateValidity_Request_message_members = {
  ...
  GetStateValidity_Request__rosidl_typesupport_introspection_c__GetStateValidity_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetStateValidity_Request__rosidl_typesupport_introspection_c__GetStateValidity_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void GetStateValidity_Response__rosidl_typesupport_introspection_c__GetStateValidity_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetStateValidity_Response__rosidl_typesupport_introspection_c__GetStateValidity_Response_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetStateValidity_Response__rosidl_typesupport_introspection_c__GetStateValidity_Response_message_members = {
  ...
  GetStateValidity_Response__rosidl_typesupport_introspection_c__GetStateValidity_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetStateValidity_Response__rosidl_typesupport_introspection_c__GetStateValidity_Response_fini_function  // function to terminate message instance (will not free memory)
};
