...
struct GetStateValidity_Response_
{
  ...
  using _contacts_type =
    std::vector<moveit_msgs::msg::ContactInformation_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ContactInformation_<ContainerAllocator>>::other>;
  _contacts_type contacts;
  using _cost_sources_type =
    std::vector<moveit_msgs::msg::CostSource_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CostSource_<ContainerAllocator>>::other>;
  _cost_sources_type cost_sources;
  using _constraint_result_type =
    std::vector<moveit_msgs::msg::ConstraintEvalResult_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ConstraintEvalResult_<ContainerAllocator>>::other>;
  ...
  Type & set__contacts(
    const std::vector<moveit_msgs::msg::ContactInformation_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ContactInformation_<ContainerAllocator>>::other> & _arg)
  {
    this->contacts = _arg;
    return *this;
  }
  Type & set__cost_sources(
    const std::vector<moveit_msgs::msg::CostSource_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::CostSource_<ContainerAllocator>>::other> & _arg)
  {
    this->cost_sources = _arg;
    return *this;
  }
  Type & set__constraint_result(
    const std::vector<moveit_msgs::msg::ConstraintEvalResult_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ConstraintEvalResult_<ContainerAllocator>>::other> & _arg)
  {
