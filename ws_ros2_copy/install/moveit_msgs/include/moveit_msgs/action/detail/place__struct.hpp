...
struct Place_Goal_
{
  ...
  using _place_locations_type =
    std::vector<moveit_msgs::msg::PlaceLocation_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::PlaceLocation_<ContainerAllocator>>::other>;
  ...
  Type & set__place_locations(
    const std::vector<moveit_msgs::msg::PlaceLocation_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::PlaceLocation_<ContainerAllocator>>::other> & _arg)
  {
...
struct Place_Result_
{
  ...
  using _trajectory_stages_type =
    std::vector<moveit_msgs::msg::RobotTrajectory_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::RobotTrajectory_<ContainerAllocator>>::other>;
  ...
  Type & set__trajectory_stages(
    const std::vector<moveit_msgs::msg::RobotTrajectory_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::RobotTrajectory_<ContainerAllocator>>::other> & _arg)
  {
