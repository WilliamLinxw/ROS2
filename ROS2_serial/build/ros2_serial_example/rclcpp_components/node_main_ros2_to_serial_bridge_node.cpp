...
#define NODE_MAIN_LOGGER_NAME "ros2_to_serial_bridge_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libros2_to_serial_bridge.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros2_to_serial_bridge::ROS2ToSerialBridge>";
