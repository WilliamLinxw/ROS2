...
struct PlanningScene_
{
  ...
  using _link_padding_type =
    std::vector<moveit_msgs::msg::LinkPadding_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::LinkPadding_<ContainerAllocator>>::other>;
  _link_padding_type link_padding;
  using _link_scale_type =
    std::vector<moveit_msgs::msg::LinkScale_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::LinkScale_<ContainerAllocator>>::other>;
  _link_scale_type link_scale;
  using _object_colors_type =
    std::vector<moveit_msgs::msg::ObjectColor_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ObjectColor_<ContainerAllocator>>::other>;
  ...
  Type & set__link_padding(
    const std::vector<moveit_msgs::msg::LinkPadding_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::LinkPadding_<ContainerAllocator>>::other> & _arg)
  {
    this->link_padding = _arg;
    return *this;
  }
  Type & set__link_scale(
    const std::vector<moveit_msgs::msg::LinkScale_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::LinkScale_<ContainerAllocator>>::other> & _arg)
  {
    this->link_scale = _arg;
    return *this;
  }
  Type & set__object_colors(
    const std::vector<moveit_msgs::msg::ObjectColor_<ContainerAllocator>, typename ContainerAllocator::template rebind<moveit_msgs::msg::ObjectColor_<ContainerAllocator>>::other> & _arg)
  {
