...
void PositionConstraint__rosidl_typesupport_introspection_c__PositionConstraint_init_function(
...
void PositionConstraint__rosidl_typesupport_introspection_c__PositionConstraint_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers PositionConstraint__rosidl_typesupport_introspection_c__PositionConstraint_message_members = {
  ...
  PositionConstraint__rosidl_typesupport_introspection_c__PositionConstraint_init_function,  // function to initialize message memory (memory has to be allocated)
  PositionConstraint__rosidl_typesupport_introspection_c__PositionConstraint_fini_function  // function to terminate message instance (will not free memory)
};
